...
export default function Button({ title, link }) {
  ...
  return (
    <Comp
      href={link}
      className="relative cursor-pointer inline-flex lg:w-auto items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold rounded-full group"
    >
