...
export default function OpenLimitedPage({ params }) {
  ...
  return (
    <main className="flex flex-col gap-[6rem] items-center justify-center p-6 pb-16 h-[100%] overflow-x-hidden bg-black text-white">
      <Link href={"/"}>
        <Image
      ...
      <div className="mt-20 md:mt-52 lg:mt-auto relative flex place-items-center before:absolute before:h-[400px] before:max-w-full before:rounded-full before:bg-gradient-radial before:from-black before:to-transparent before:blur-3xl before:content-[''] after:absolute after:-z-20 after:h-[250px] after:max-w-full after:bg-gradient-conic after:from-black after:via-black after:blur-3xl after:content-[''] before:lg:h-[500px] z-[-1]">
        <h1 className="relative drop-shadow-[0_0_0.3rem_#ffffff70] text-5xl text-center">
